...
import (
	...
	anypb1 "github.com/DataDog/vtprotobuf/types/known/anypb"
	durationpb1 "github.com/DataDog/vtprotobuf/types/known/durationpb"
	fieldmaskpb1 "github.com/DataDog/vtprotobuf/types/known/fieldmaskpb"
	structpb1 "github.com/DataDog/vtprotobuf/types/known/structpb"
	timestamppb1 "github.com/DataDog/vtprotobuf/types/known/timestamppb"
	wrapperspb1 "github.com/DataDog/vtprotobuf/types/known/wrapperspb"
...
func (m *TestAllTypesProto3) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			...
			m.OptionalString = unsafe.String(&dAtA[iNdEx], intStringLen)
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OptionalBytes", wireType)
		...
		case 24:
			...
			m.OptionalStringPiece = unsafe.String(&dAtA[iNdEx], intStringLen)
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OptionalCord", wireType)
			...
			m.OptionalCord = unsafe.String(&dAtA[iNdEx], intStringLen)
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RecursiveMessage", wireType)
		...
		case 113:
			...
			m.OneofField = &TestAllTypesProto3_OneofString{OneofString: unsafe.String(&dAtA[iNdEx], intStringLen)}
			iNdEx = postIndex
		case 114:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OneofBytes", wireType)
